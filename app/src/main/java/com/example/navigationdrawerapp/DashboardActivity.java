...
public class DashboardActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        */
        if (view.getId() == R.id.navigationBar) {
            ...
            showToast("ll_Fourth");
            drawerLayout.closeDrawer(navigationView, true);
        } else if (view.getId() == R.id.ll_Fifth) {
            showToast("ll_Fifth");
            drawerLayout.closeDrawer(navigationView, true);
        } else if (view.getId() == R.id.ll_Sixth) {
            showToast("ll_Sixth");
            drawerLayout.closeDrawer(navigationView, true);
        } else if (view.getId() == R.id.ll_Seventh) {
            showToast("ll_Seventh");
            drawerLayout.closeDrawer(navigationView, true);
        } else if (view.getId() == R.id.iv_logout) {
            showToast("iv_logout");
            drawerLayout.closeDrawer(navigationView, true);
